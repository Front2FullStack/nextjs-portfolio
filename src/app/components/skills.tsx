  ...
  return (
    <section id={id} className="scroll-mt-20">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 gradient-text">{title}</h2>
                  ...
                  <div className="relative z-10">
                    ...
                    {showActions && (
                      ...
                      >
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="flex-1">
                          <Button variant="outline" className="w-full hover:bg-muted/80 hover:border-primary/30 transition-all duration-300 font-medium">
