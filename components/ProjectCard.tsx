...
const ProjectCard: FunctionComponent<{
  ...
  return (
    <div>
      ...
      {showDetail === id && (
        <div className="absolute top-0 left-0 z-10 grid w-full h-auto py-2 pl-3 text-black bg-gray-100 md:grid-cols-2 gap-x-6 dark:text-white dark:bg-black">
          ...
          <button className="absolute p-1 bg-gray-200 rounded-full top-3 right-3 focus:outline-none dark:bg-black">
            <MdClose size={24} onClick={() => setShowDetail(null)} />
          </button>
        </div>
      )}
    </div>
